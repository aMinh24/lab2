    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(6853), false, "school", "sm_student", "student", "Student", 1, "Student" },
                    { 2, new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(6856), false, "format_shapes", "sm_instructor", "instructor", "Instructor", 2, "Instructor" },
                    { 3, new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(6858), false, "apps", "sm_apps", "apps", "Apps", 3, "Apps" },
                    { 4, new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(6861), false, "message", "sm_messaging", "messaging", "Messaging", 4, "Messaging" },
                    { 5, new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(6863), false, "account_box", "sm_account", "account", "Account", 5, "Account" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7016), false, "home", "", "home_meta", "Home", 1, 1, "Home" },
                    { 2, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7022), false, "local_library", "courses", "courses_meta", "Browse Courses", 2, 1, "Browse Courses" },
                    { 3, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7025), false, "style", "paths", "paths_meta", "Browse Paths", 3, 1, "Browse Paths" },
                    { 4, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7027), false, "account_box", "student/dashboard", "dashboard_meta", "Student Dashboard", 4, 1, "Student Dashboard" },
                    { 5, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7029), false, "search", "student/mycourse", "my_courses_meta", "My Courses", 5, 1, "My Courses" },
                    { 6, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7054), false, "timeline", "student/mypath", "my_paths_meta", "My Paths", 6, 1, "My Paths" },
                    { 7, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7056), false, "change_history", "student/pathdetail", "path_details_meta", "Path Details", 7, 1, "Path Details" },
                    { 8, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7058), false, "face", "student/courseprview", "course_preview_meta", "Course Preview", 8, 1, "Course Preview" },
                    ...
                    { 17, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7076), false, "school", "instructor", "instructor_dashboard_meta", "Instructor Dashboard", 1, 2, "Instructor Dashboard" },
                    { 18, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7078), false, "import_contacts", "instructor/mycourses", "manage_courses_meta", "Manage Courses", 2, 2, "Manage Courses" },
                    ...
                    { 20, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7082), false, "trending_up", "instructor/earnings", "earnings_meta", "Earnings", 4, 2, "Earnings" },
                    { 21, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7084), false, "receipt", "instructor/statement", "statement_meta", "Statement", 5, 2, "Statement" },
                    ...
                    { 24, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7089), false, "", "pricing.html", "pricing_meta", "Pricing", 1, 5, "Pricing" },
                    { 25, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7091), false, "", "login.html", "login_meta", "Login", 2, 5, "Login" },
                    { 26, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7093), false, "", "signup.html", "signup_meta", "Signup", 3, 5, "Signup" },
                    { 27, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7095), false, "", "signup-payment.html", "payment_meta", "Payment", 4, 5, "Payment" },
                    { 28, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7097), false, "", "reset-password.html", "reset_password_meta", "Reset Password", 5, 5, "Reset Password" },
                    { 29, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7099), false, "", "change-password.html", "change_password_meta", "Change Password", 6, 5, "Change Password" },
                    { 30, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7101), false, "", "edit-account.html", "edit_account_meta", "Edit Account", 7, 5, "Edit Account" },
                    { 31, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7103), false, "", "edit-account-profile.html", "profile_privacy_meta", "Profile & Privacy", 8, 5, "Profile & Privacy" },
                    { 32, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7105), false, "", "edit-account-notifications.html", "email_notifications_meta", "Email Notifications", 9, 5, "Email Notifications" },
                    { 33, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7107), false, "", "edit-account-password.html", "account_password_meta", "Account Password", 10, 5, "Account Password" },
                    { 34, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7109), false, "", "billing.html", "subscription_meta", "Subscription", 11, 5, "Subscription" },
                    { 35, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7111), false, "", "billing-upgrade.html", "upgrade_account_meta", "Upgrade Account", 12, 5, "Upgrade Account" },
                    { 38, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7112), false, "", "billing-invoice.html", "invoice_meta", "Invoice", 8, 5, "Invoice" },
                    { 39, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7114), false, "", "messages.html", "messages_meta", "Messages", 1, 4, "Messages" },
                    { 40, "", new DateTime(2024, 12, 6, 21, 54, 47, 747, DateTimeKind.Local).AddTicks(7116), false, "", "email.html", "email_meta", "Email", 2, 4, "Email" }
                });
